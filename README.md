...
- [RFC-0001: escolha da nuvem](docs/rfcs/0001-escolha-da-nuvem.md).
- [RFC-0002: banco gerenciado](docs/rfcs/0002-escolha-do-banco-de-dados.md).
- [RFC-0003: autenticação](docs/rfcs/0003-estrategia-de-autenticacao.md).
- [Operação OCI, HTTPS, telemetria e reprodução dos testes](deploy/oci/README.md).
- [Ambiente kind local](infra/README.md), [manifestos locais](k8s/README.md) e [chart AWS preservado](deploy/helm/oficina/README.md).
